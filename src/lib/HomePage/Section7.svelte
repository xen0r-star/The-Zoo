<script lang="ts">
    import LoveChameleon from '$lib/assets/HomePage/LoveChameleon.svg';
</script>
...
<div class="section-container">
    ...
    <a href="https://github.com/xen0r-star/" aria-label="github - Xen0r-star" target="_blank" class="github-link">
        <svg width="512" height="512" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg" class="full">
    ...
    <div class="love-chameleon">
        <img src={LoveChameleon} alt="Love Chameleon" class="full" />
    </div>
</div>